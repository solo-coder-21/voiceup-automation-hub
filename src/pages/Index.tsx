...
import { ArrowDown, Mic, BarChart3, Users, Bot, PhoneCall, Search } from 'lucide-react';
            ...
            <div className="relative">
              ...
              <div className="flex flex-col items-center space-y-8">
                ...
                <div className="flex items-center space-x-8">
                  <div className="group">
                    <div className="bg-voiceup-skyblue text-white px-6 py-4 rounded-2xl shadow-lg cursor-pointer hover:bg-voiceup-periwinkle transition-all duration-300 hover:scale-105">
                      <span className="font-semibold">PSTN</span>
                    </div>
                  </div>
                  <div className="group">
                    <div className="bg-voiceup-skyblue text-white px-6 py-4 rounded-2xl shadow-lg cursor-pointer hover:bg-voiceup-periwinkle transition-all duration-300 hover:scale-105">
                      <span className="font-semibold">SBC</span>
                    </div>
                  </div>
                </div>

                {/* Connection Lines */}
                <div className="w-1 h-8 bg-gradient-to-b from-voiceup-skyblue to-voiceup-periwinkle rounded-full"></div>

                {/* VoiceUp Service & AI Service Level */}
                <div className="flex items-center space-x-12">
                  <div className="group">
                    <div className="bg-voiceup-periwinkle text-white px-8 py-6 rounded-2xl shadow-lg cursor-pointer hover:bg-voiceup-navy transition-all duration-300 hover:scale-105">
                      <div className="flex items-center space-x-2">
                        <Mic className="h-6 w-6" />
                        <span className="font-semibold">VoiceUp Service</span>
                      </div>
                    </div>
                  </div>
                  <div className="group">
                    <div className="bg-voiceup-skyblue text-white px-8 py-6 rounded-2xl shadow-lg cursor-pointer hover:bg-voiceup-periwinkle transition-all duration-300 hover:scale-105">
                      <div className="flex items-center space-x-2">
                ...
                {/* Connection Lines */}
                <div className="w-1 h-8 bg-gradient-to-b from-voiceup-periwinkle to-voiceup-skyblue rounded-full"></div>

                {/* PBX Level */}
                <div className="group">
                  <div className="bg-voiceup-navy text-white px-8 py-6 rounded-2xl shadow-lg cursor-pointer hover:bg-voiceup-periwinkle transition-all duration-300 hover:scale-105">
                    <div className="flex items-center space-x-2">
                ...
                {/* Connection Lines */}
                <div className="w-1 h-8 bg-gradient-to-b from-voiceup-navy to-voiceup-skyblue rounded-full"></div>

                {/* Agent Desktop Level */}
                <div className="flex items-center space-x-8">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="group">
                      <div className="bg-gradient-to-br from-voiceup-skyblue to-voiceup-periwinkle text-white px-6 py-4 rounded-2xl shadow-lg cursor-pointer hover:scale-105 transition-all duration-300">
                        <div className="text-center">
                          <Users className="h-6 w-6 mx-auto mb-2" />
                          <div className="text-sm font-semibold">VoiceUp</div>
                ...
                <div className="mt-8 p-4 bg-voiceup-blush rounded-2xl">
                  <span className="text-voiceup-navy font-semibold">Customer Premise</span>
                </div>
              </div>
            </div>
          </div>
